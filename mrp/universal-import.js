...
export const IMPORT_SCHEMAS={
  ...
  skus:{label:'Items & SKU',key:['code'],fields:{
    code:field('SKU',['Stock Code','Item Code','Barcode','Stok Kodu','Malzeme Kodu','کد کالا','بارکد'],{required:true}),barcode:field('GTIN / Barcode',['GTIN','EAN-13','EAN13','UPC-A','UPCA','Barcode Value','Barkod Değeri','بارکد استاندارد']),
